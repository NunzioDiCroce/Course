...
*/
const petsTre = pets.reverse();
for (var i=0; i<petsTre.length; i++) {
    console.log(petsTre[i]);
}
...
*/
const petsQuattro = petsTre.slice(1,5);
petsQuattro.push('redfish');
console.log(petsQuattro);
